...
<section>
    ...
    <hr/>
    <a href="create_meal"><spring:message code="meal.add"/></a>
    <hr/>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="update_meal?id=${meal.id}"><spring:message code="meal.update"/></a></td>
                <td><a href="delete_meal?id=${meal.id}"><spring:message code="meal.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
