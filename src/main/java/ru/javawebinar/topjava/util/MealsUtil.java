...
public class MealsUtil {
    public final List<Meal> MEALS = Arrays.asList(
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 10, 10, 0), "Завтрак", 500),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 10, 13, 0), "Обед", 1000),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 10, 20, 0), "Ужин", 500),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 11, 10, 0), "Завтрак", 1000),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 11, 13, 0), "Обед", 500),
            new Meal(LocalDateTime.of(2017, Month.NOVEMBER, 11, 20, 0), "Ужин", 510)
    );
...
/*
    public static List<MealWithExceed> getFilteredWithExceededByCycle(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        meals.forEach(meal -> {
            if (DateTimeUtil.isBetweenTimes(meal.getTime(), startTime, endTime)) {
    ...
    public static List<MealWithExceed> getFilteredWithExceededInOnePass2(List<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        final class Aggregate {
            ...
            private void accumulate(Meal meal) {
                ...
                if (DateTimeUtil.isBetweenTimes(meal.getDateTime().toLocalTime(), startTime, endTime)) {
                    dailyMeals.add(meal);
                }
            }
