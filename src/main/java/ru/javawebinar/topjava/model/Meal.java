...
@NamedQueries({
        @NamedQuery(name = Meal.BY_ID, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user " +
        ...
        @NamedQuery(name = Meal.BETWEEN, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user WHERE m.user.id=:userId " +
...
public class Meal extends AbstractBaseEntity {
    ...
    @Convert(converter = ru.javawebinar.topjava.util.LocalDateTimeConverter.class)
    @NotNull
