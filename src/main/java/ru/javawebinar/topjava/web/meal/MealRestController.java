...
public class MealRestController extends AbstractMealController {
    ...
    public List<MealWithExceed> getBetween(
            @DateTimeFormat(iso = ISO.DATE_TIME) @RequestParam("startDate") LocalDateTime startDate,
            @DateTimeFormat(iso = ISO.DATE_TIME) @RequestParam("endDate") LocalDateTime endDate) {
